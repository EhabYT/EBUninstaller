...
def check_subsystems(verbose=False, quiet=False):
    ...
    required_modules = [
        ...
        "source/EBUninstaller/Controls/ModernAppDetailsCard.cs",
        "source/EBUninstaller/Controls/ModernSystemResourceMetricsBar.cs",
        "source/UninstallTools/SystemTools/FontCacheRepairEngine.cs",
        "source/UninstallTools/SystemTools/DeviceDriverBackupEngine.cs",
        "source/UninstallTools/JunkCleaner/CryptnetUrlCacheCleanerEngine.cs",
        "source/UninstallTools/SystemTools/PrintSpoolerHealthRepairEngine.cs",
        "source/EBUninstaller/Dialogs/FontCacheRepairWindow.cs",
        "source/EBUninstaller/Dialogs/DeviceDriverBackupWindow.cs",
        "source/EBUninstaller/Dialogs/CryptnetUrlCacheCleanerWindow.cs",
        "source/EBUninstaller/Dialogs/PrintSpoolerHealthRepairWindow.cs",
        "source/UninstallTools/PrivacyCleaner/MruRecentHistoryCleanerEngine.cs",
        "source/UninstallTools/PrivacyCleaner/TaskbarJumpListCleanerEngine.cs",
        "source/UninstallTools/SystemTools/DnsClientCacheHealthEngine.cs",
        "source/UninstallTools/SecurityHardening/WindowsTelemetryDiagTrackEngine.cs",
        "source/EBUninstaller/Dialogs/MruRecentHistoryCleanerWindow.cs",
        "source/EBUninstaller/Dialogs/TaskbarJumpListCleanerWindow.cs",
        "source/EBUninstaller/Dialogs/DnsClientCacheHealthWindow.cs",
        "source/EBUninstaller/Dialogs/WindowsTelemetryDiagTrackWindow.cs",
        "source/UninstallTools/SystemTools/NetworkAdapterBindingAuditorEngine.cs",
        "source/UninstallTools/Backup/VssWriterHealthAuditorEngine.cs",
        "source/UninstallTools/SystemTools/DotNetNgenOptimizationEngine.cs",
        "source/UninstallTools/SystemTools/WindowsEventLogRetentionPolicyEngine.cs",
        "source/EBUninstaller/Dialogs/NetworkAdapterBindingAuditorWindow.cs",
        "source/EBUninstaller/Dialogs/VssWriterHealthAuditorWindow.cs",
        "source/EBUninstaller/Dialogs/DotNetNgenOptimizationWindow.cs",
        "source/EBUninstaller/Dialogs/WindowsEventLogRetentionPolicyWindow.cs",
        "source/UninstallTools/Backup/SystemRestorePointIntegrityAuditorEngine.cs",
        "source/UninstallTools/JunkCleaner/GpuDriverCacheCleanerEngine.cs",
        "source/UninstallTools/StoreApps/AppxProvisionedPackageRemoverEngine.cs",
        "source/UninstallTools/SystemTools/WindowsUpdateRollbackHealthEngine.cs",
        "source/EBUninstaller/Dialogs/SystemRestorePointIntegrityAuditorWindow.cs",
        "source/EBUninstaller/Dialogs/GpuDriverCacheCleanerWindow.cs",
        "source/EBUninstaller/Dialogs/AppxProvisionedPackageRemoverWindow.cs",
        "source/EBUninstaller/Dialogs/WindowsUpdateRollbackHealthWindow.cs",
        "source/UninstallTools/PrivacyCleaner/TerminalColorPaletteProfilesCleanerEngine.cs",
        "source/UninstallTools/JunkCleaner/DirectInputControllerProfileCleanerEngine.cs",
        "source/UninstallTools/SystemTools/AppExecutionAliasManagerEngine.cs",
        "source/UninstallTools/SystemTools/SystemTimerResolutionOptimizerEngine.cs",
        "source/EBUninstaller/Dialogs/TerminalColorPaletteProfilesCleanerWindow.cs",
        "source/EBUninstaller/Dialogs/DirectInputControllerProfileCleanerWindow.cs",
        "source/EBUninstaller/Dialogs/AppExecutionAliasManagerWindow.cs",
        "source/EBUninstaller/Dialogs/SystemTimerResolutionOptimizerWindow.cs",
...
def check_unit_tests(verbose=False, quiet=False):
    ...
    test_files = [
        ...
        "source/EBUninstallerTests/ModernAppDetailsCardTests.cs",
        "source/EBUninstallerTests/ModernSystemResourceMetricsBarTests.cs",
        "source/EBUninstallerTests/FontCacheRepairTests.cs",
        "source/EBUninstallerTests/DeviceDriverBackupTests.cs",
        "source/EBUninstallerTests/CryptnetUrlCacheCleanerTests.cs",
        "source/EBUninstallerTests/PrintSpoolerHealthRepairTests.cs",
        "source/EBUninstallerTests/MruRecentHistoryCleanerTests.cs",
        "source/EBUninstallerTests/TaskbarJumpListCleanerTests.cs",
        "source/EBUninstallerTests/DnsClientCacheHealthTests.cs",
        "source/EBUninstallerTests/WindowsTelemetryDiagTrackTests.cs",
        "source/EBUninstallerTests/NetworkAdapterBindingAuditorTests.cs",
        "source/EBUninstallerTests/VssWriterHealthAuditorTests.cs",
        "source/EBUninstallerTests/DotNetNgenOptimizationTests.cs",
        "source/EBUninstallerTests/WindowsEventLogRetentionPolicyTests.cs",
        "source/EBUninstallerTests/SystemRestorePointIntegrityAuditorTests.cs",
        "source/EBUninstallerTests/GpuDriverCacheCleanerTests.cs",
        "source/EBUninstallerTests/AppxProvisionedPackageRemoverTests.cs",
        "source/EBUninstallerTests/WindowsUpdateRollbackHealthTests.cs",
        "source/EBUninstallerTests/TerminalColorPaletteProfilesCleanerTests.cs",
        "source/EBUninstallerTests/DirectInputControllerProfileCleanerTests.cs",
        "source/EBUninstallerTests/AppExecutionAliasManagerTests.cs",
        "source/EBUninstallerTests/SystemTimerResolutionOptimizerTests.cs",
